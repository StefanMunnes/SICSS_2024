...
start_dates <- seq(as.Date("2024-01-01"), as.Date("2024-07-15"), by = "2 days")
...
#writeLines(urls, "data/foxurls_abortion2.txt")
write_csv(urls, "~/SICSS_2024/projects/abortion laws/fox_urls.csv")
