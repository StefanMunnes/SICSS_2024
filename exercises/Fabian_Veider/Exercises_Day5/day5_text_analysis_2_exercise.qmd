...
embeddings_matrix <- py_to_r(py$embeddings)
# Set the number of clusters
k <- 4

# Perform K-means clustering
set.seed(42)
kmeans_result <- kmeans(embeddings_matrix, centers = k, nstart = 25)

# Get the cluster labels
labels <- kmeans_result$cluster

# Perform t-SNE
tsne_result <- Rtsne(embeddings_matrix, dims = 2, perplexity = 3, verbose = TRUE, max_iter = 1000)
