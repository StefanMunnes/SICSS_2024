...
while(TRUE) {
  ...
  # flatten  with purr package - careful to insert purrr:: as otherwise the function     is masked by the jsonlite package!
    ...
    results <- rbind(results, df_members_unique)
        
  # if (condition) { #content = zero?
  #   break
  # }
