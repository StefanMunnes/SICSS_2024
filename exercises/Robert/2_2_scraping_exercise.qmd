...
## Task 4: Automate Page Navigation to get URLS from Multiple Pages

```{r}

base_url <- "https://www.theguardian.com/technology/artificialintelligenceai?page="


for (page in range(1:10)) {
      modified_url <- paste0(base_url + [i]),
      print("Scraping urls from page" + [i])
}
