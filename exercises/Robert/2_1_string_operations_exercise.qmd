...
no_fruit <- str_replace_all(no_break, "Orange", "")
print(no_fruit)
...
no_space <- str_trim(no_fruit, side = c("both"))
print(no_space)
...
email <- str_extract(no_space, "sicss.2023@wzb.eu")
print(email)
```
...
```{r}
str_replace_all(no_space, "impovemend", "improvements")
